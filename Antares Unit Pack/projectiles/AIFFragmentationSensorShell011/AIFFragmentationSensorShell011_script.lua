...
AIFFragmentationSensorShell011 = Class(AArtilleryFragmentationSensorShellProjectile) {
               
    OnImpact = function(self, TargetType, TargetEntity) 
        local FxFragEffect = EffectTemplate.Aeon_QuanticClusterFrag01
        local ChildProjectileBP = '/mods/Antares Unit Pack/projectiles/AIFFragmentationSensorShell021/AIFFragmentationSensorShell021_proj.bp'  
		...
		# Create several other projectiles in a dispersal pattern
		        ...
		        local spreadMul = 2.4 # Adjusts the width of the dispersal        
...
TypeClass = AIFFragmentationSensorShell011