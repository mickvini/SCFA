...
CIFEMPFluxWarhead09 = Class(CEMPFluxWarheadProjectile) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
            ...
            nukeProjectile = self:CreateProjectile('/mods/REL Nuke Mod 1.46/hook/projectiles/CIFEMPFluxWarhead10/CIFEMPFluxWarhead10_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
