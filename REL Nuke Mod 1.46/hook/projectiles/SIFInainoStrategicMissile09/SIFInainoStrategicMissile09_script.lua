...
SIFInainoStrategicMissile01 = Class(SIFInainoStrategicMissile) {
	...
	InitialEffects = {
		...
		'/mods/REL Nuke Mod 1.46/hook/effects/Emitters/snukelense.bp',
	},    
    ThrustEffects = {
		'/effects/emitters/seraphim_inaino_fxtrails_01_emit.bp',
		'/effects/emitters/seraphim_inaino_fxtrails_02_emit.bp',
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
            ...
            nukeProjectile = self:CreateProjectile('/mods/REL Nuke Mod 1.46/hook/effects/entities/InainoEffectController10/InainoEffectController10_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
