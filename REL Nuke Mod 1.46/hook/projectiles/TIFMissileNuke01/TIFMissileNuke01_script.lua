...
TIFMissileNuke01 = Class(TIFMissileNuke) {
    ...
    InitialEffects = {'/effects/emitters/nuke_munition_launch_trail_02_emit.bp',
					  '/mods/REL Nuke Mod 1.46/hook/effects/Emitters/tnuketake.bp',
	},
    LaunchEffects = {
		...
		'/mods/REL Nuke Mod 1.46/hook/effects/Emitters/tnuketrail.bp',
		'/mods/REL Nuke Mod 1.46/hook/effects/Emitters/tnukelense.bp',
    },
    ThrustEffects = {'/effects/emitters/nuke_munition_launch_trail_04_emit.bp',
    				...
    				## '/mods/REL Nuke Mod 1.46/hook/effects/Emitters/tnuketrailc.bp',
