...
TIFMissileNuke09 = Class(TIFMissileNuke) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
			...
			nukeProjectile = self:CreateProjectile('/mods/REL Nuke Mod 1.46/hook/effects/Entities/UEFNukeEffectController10/UEFNukeEffectController10_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
