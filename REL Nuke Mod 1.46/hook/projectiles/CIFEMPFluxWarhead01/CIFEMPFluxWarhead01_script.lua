...
CIFEMPFluxWarhead01 = Class(CEMPFluxWarheadProjectile) {
    ...
    InitialEffects = {'/effects/emitters/nuke_munition_launch_trail_02_emit.bp',
					 '/mods/REL Nuke Mod 1.46/hook/effects/Emitters/cnukelense.bp',
					 '/mods/REL Nuke Mod 1.46/hook/effects/Emitters/cnuketake.bp',
	},
    LaunchEffects = {'/effects/emitters/nuke_munition_launch_trail_03_emit.bp',
					 '/mods/REL Nuke Mod 1.46/hook/effects/Emitters/cnuketrail.bp',
	},
