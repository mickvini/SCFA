...
InainoEffectController10 = Class(NullShell) {
    ...
    MainBlast = function( self, army )
        ...
        CreateLightParticle(self, -1, self:GetArmy(), 80, 7, 'flare_lens_add_03', 'ramp_white_07' )
        
        # Create our decals
        CreateDecal( self:GetPosition(), RandomFloat(0.0,6.28), 'Scorch_012_albedo', '', 'Albedo', 40, 40, 500, 0, self:GetArmy())          
        ...
        plume:SetVelocity(5.0)
        plume:SetAcceleration(-0.175)  
...
TypeClass = InainoEffectController10
