#
# Auto targeting for the Aeon Land-Based Tactical Missile
#
local AMissileSerpentineProjectile = import('/lua/aeonprojectiles.lua').AMissileSerpentineProjectile3
