    ...
    BurningState = State {
        ...
        Main = function(self)
            ...
            for k, v in FireEffects do
                fx = CreateEmitterAtEntity(self, -1, v ):OffsetEmitter(0, 0.5, 0):ScaleEmitter(10)
            ...
            for i = 7, 3, -1 do
                ...
                for k, v in FireEffects do
                    local fx = CreateAttachedEmitter(self, -2, -1, v ):OffsetEmitter(0, 0, 0.3):ScaleEmitter(i * 1)
                    table.insert(effects, fx)
                    self.Trash:Add(fx)
                end
                WaitSeconds(2 + Random(1, 20) * 0.5)
