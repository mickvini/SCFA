...
CIFEMPFluxWarhead01 = Class(CEMPFluxWarheadProjectile) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
            ...
            nukeProjectile = self:CreateProjectile('/mods/BlackOpsBalance/effects/entities/CybranNukeEffectController01/CybranNukeEffectController01_proj.bp', 0, 0, 0, 0, 0, 0):SetCollision(false)
