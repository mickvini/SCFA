...
local CybranNukeEffect04 = '/mods/BlackOpsBalance/projectiles/CybranPlasmaBall01/CybranPlasmaBall01_proj.bp' 
local CybranNukeEffect05 = '/mods/BlackOpsBalance/effects/Entities/CybranNukeEffect05/CybranNukeEffect05_proj.bp'
local CybranNukeEffect06 = '/mods/BlackOpsBalance/effects/Entities/CybranNukeEffect06/CybranNukeEffect06_proj.bp'
...
CybranNukeEffectController01 = Class(NullShell) {
    ...
    CreateEffectInnerPlasma = function(self)
        ...
        for i = 0, (num_projectiles -1) do            
            ...
            local proj = self:CreateProjectile( CybranNukeEffect05, px, -10, pz, xVec, 0, zVec )
    ...
    EffectThread = function(self)
        ...
        self:CreateProjectile('/mods/BlackOpsBalance/effects/entities/CybranNukeEffect01/CybranNukeEffect01_proj.bp',0,FireballDomeYOffset,0,0,0,1)
        ...
        for i = 0, (num_projectiles -1) do            
            ...
            local proj = self:CreateProjectile( CybranNukeEffect04, px, py, pz, xVec, yVec, zVec )
    ...
    CreateHeadConvectionSpinners = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            local proj = self:CreateProjectile('/mods/BlackOpsBalance/effects/entities/CybranNukeEffect03/CybranNukeEffect03_proj.bp', x, HeightOffset, z, x, 0, z)
...
TypeClass = CybranNukeEffectController01
