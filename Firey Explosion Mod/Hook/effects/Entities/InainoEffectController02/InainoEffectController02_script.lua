#****************************************************************************
#**
#**  File     :  \data\effects\Entities\InainoEffectController02\InainoBombEffectController02_script.lua
...
InainoEffectController02 = Class(NullShell) {
    ...
    MainBlast = function( self, army )
        ...
        CreateLightParticle(self, -1, self:GetArmy(), 640, 56, 'flare_lens_add_03', 'ramp_white_07' )
        
        # Create our decals
        CreateDecal( self:GetPosition(), RandomFloat(0.0,24.112), 'Scorch_012_albedo', '', 'Albedo', 160, 160, 2000, 0, self:GetArmy())          
...
TypeClass = InainoEffectController02
