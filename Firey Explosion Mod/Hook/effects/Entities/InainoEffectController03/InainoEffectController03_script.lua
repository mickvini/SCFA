...
InainoEffectController03 = Class(NullShell) {
    ...
    MainBlast = function( self, army )
        ...
        CreateLightParticle(self, -1, self:GetArmy(), 320, 28, 'flare_lens_add_03', 'ramp_white_07' )
        
        # Create our decals
        CreateDecal( self:GetPosition(), RandomFloat(0.0,12.56), 'Scorch_012_albedo', '', 'Albedo', 80, 80, 1000, 0, self:GetArmy())          
        ...
        self:ShakeCamera( 110, 20, 0, 5 )        

		WaitSeconds(0.3)
        
        # Create upward moving smoke plume
        local plume = self:CreateProjectile('/effects/entities/SIFInainoStrategicMissileEffect04/SIFInainoStrategicMissileEffect04_proj.bp', 0, 6, 0, 0, 0, 0)
        plume:SetLifetime(10.7)
        ...
        for i = 0, (num_projectiles -1) do            
            ...
            proj:SetLifetime(48.0)
            proj:SetVelocity(20.0)
...
TypeClass = InainoEffectController03
