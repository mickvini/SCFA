...
UEFNukeEffectController02 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        CreateLightParticle(self, -1, army, 140, 8, 'glow_02', 'ramp_red_02')
        WaitSeconds(0.25)
        CreateLightParticle(self, -1, army, 320, 40, 'glow_03', 'ramp_fire_06')
      ...
      CreateEmitterAtEntity(self, army, v )
        ...
        CreateLightParticle(self, -1, army, 1200, 1000, 'glow_03', 'ramp_nuke_04')
        
        # Create ground decals
        local orientation = RandomFloat(0,2*math.pi)
        CreateDecal(position, orientation, 'Crater01_albedo', '', 'Albedo', 200, 200, 4800, 0, army)
        CreateDecal(position, orientation, 'Crater01_normals', '', 'Normals', 200, 200, 4800, 0, army)       
        CreateDecal(position, orientation, 'nuke_scorch_003_albedo', '', 'Albedo', 240, 240, 4800, 0, army)    
    ...
    local inner_upper_height = 12
    local outer_lower_height = 8
    local outer_upper_height = 12
...
TypeClass = UEFNukeEffectController02
