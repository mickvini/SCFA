...
SeraphimNukeEffectController01 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        DamageRing(self, position, 0.1, 5760, 1, 'Force', true)
        WaitSeconds(0.1)
        DamageRing(self, position, 0.1, 5760, 1, 'Force', true)

        # Create full-screen glow flash
        CreateLightParticle(self, -1, army, 4480, 640, 'glow_02', 'ramp_blue_22')
        WaitSeconds( 0.3 )
        CreateLightParticle(self, -1, army, 2560, 1152, 'glow_02', 'ramp_blue_16')
        ...
        WaitSeconds( 3.0 )
        CreateLightParticle(self, -1, army, 5120, 192, 'glow_02', 'ramp_blue_16')
        WaitSeconds( 0.1 )       
        CreateLightParticle(self, -1, army, 1920, 1920, 'glow', 'ramp_blue_22')
        ...
        CreateDecal(position, orientation, 'Scorch_012_albedo', '', 'Albedo', 9600, 9600, 38400, 0, army)
        CreateDecal(position, orientation, 'Crater01_normals', '', 'Normals', 4800, 4800, 38400, 0, army)       
        ...
        plume:SetLifetime(4800.0)
        plume:SetVelocity(320.0)
