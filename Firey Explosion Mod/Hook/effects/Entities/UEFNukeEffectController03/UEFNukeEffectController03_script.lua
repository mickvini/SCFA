#****************************************************************************
#**
#**  File     :  /effects/Entities/UEFNukeEffectController02/UEFNukeEffectController02_script.lua
...
UEFNukeEffectController03 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        CreateLightParticle(self, -1, army, 70, 8, 'glow_02', 'ramp_red_02')
        WaitSeconds(0.25)
        CreateLightParticle(self, -1, army, 160, 40, 'glow_03', 'ramp_fire_06')
      ...
      CreateEmitterAtEntity(self, army, v )
        ...
        CreateLightParticle(self, -1, army, 600, 500, 'glow_03', 'ramp_nuke_04')
        
        # Create ground decals
        local orientation = RandomFloat(0,2*math.pi)
        CreateDecal(position, orientation, 'Crater01_albedo', '', 'Albedo', 100, 100, 2400, 0, army)
        CreateDecal(position, orientation, 'Crater01_normals', '', 'Normals', 100, 100, 2400, 0, army)       
        CreateDecal(position, orientation, 'nuke_scorch_003_albedo', '', 'Albedo', 120, 120, 2400, 0, army)     

    # Knockdown force rings
        DamageRing(self, position, 0.1, 22.5, 1, 'Force', true)
        WaitSeconds(0.1)
        DamageRing(self, position, 0.1, 22.5, 1, 'Force', true)
    ...
    WaitSeconds(1)
      ...
      proj:SetVelocity(0,1.5,0) 
          proj:SetBallisticAcceleration(-0.025)            
        end   
    end,
    ...
    local inner_lower_height = 2
    local inner_upper_height = 6
    local outer_lower_height = 4
    local outer_upper_height = 6
...
TypeClass = UEFNukeEffectController03
