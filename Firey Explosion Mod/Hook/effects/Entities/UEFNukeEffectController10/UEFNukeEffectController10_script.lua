...
UEFNukeEffectController10 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        CreateLightParticle(self, -1, army, 17.5, 2, 'glow_02', 'ramp_red_02')
        WaitSeconds(0.25)
      ...
      CreateEmitterAtEntity(self, army, v )
        ...
        CreateLightParticle(self, -1, army, 150, 125, 'glow_03', 'ramp_nuke_04')
        
        # Create ground decals
        local orientation = RandomFloat(0,2*math.pi)
        CreateDecal(position, orientation, 'Crater01_albedo', '', 'Albedo', 25, 25, 600, 0, army)
        CreateDecal(position, orientation, 'Crater01_normals', '', 'Normals', 25, 25, 600, 0, army)       
        CreateDecal(position, orientation, 'nuke_scorch_003_albedo', '', 'Albedo', 30, 30, 600, 0, army)    
    ...
    local inner_upper_height = 1.5
    local outer_lower_height = 1
    local outer_upper_height = 1.5
...
TypeClass = UEFNukeEffectController10
