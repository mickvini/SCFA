#****************************************************************************
#**
#**  File     :  /projectiles/CIFEMPFluxWarhead04/CIFEMPFluxWarhead04_script.lua
...
AIFQuantumWarhead04 = Class(NullShell) {
    ...
    CreateNuclearExplosion = function(self)
        ...
        CreateLightParticle(self, -1, army, 800, 800, 'beam_white_01', 'ramp_quantum_warhead_flash_01')
    ...
    ShakeAndBurnMe = function(self, army)
        self:ShakeCamera( 300, 6, 0, 40 )
        WaitSeconds( 0.5 )
        #CreateDecal(position, heading, textureName, type, sizeX, sizeZ, lodParam, duration, army)");
        local orientation = RandomFloat(0,2*math.pi)
        CreateDecal(self:GetPosition(), orientation, 'Crater01_albedo', '', 'Albedo', 200, 200, 4800, 0, army)
        CreateDecal(self:GetPosition(), orientation, 'Crater01_normals', '', 'Normals', 200, 200, 4800, 0, army)
        self:ShakeCamera( 420, 40, 0, 8 )
        WaitSeconds( 2 )
        self:ShakeCamera( 300, 4, 0, 60 )
    end,
    ...
    InnerCloudFlares = function(self, army)
        ...
        for i = 0, (numFlares - 1) do
            ...
            if math.mod(i,11) == 0 then
                CreateLightParticle(self, -1, army, 52, 12, 'beam_white_01', 'ramp_quantum_warhead_flash_01')
            end
