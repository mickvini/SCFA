...
AIFQuantumWarhead09 = Class(AQuantumWarheadProjectile) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
            ...
            nukeProjectile = self:CreateProjectile('/mods/Firey Explosion Mod/hook/projectiles/AIFQuantumWarhead10/AIFQuantumWarhead10_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
