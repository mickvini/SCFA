...
AIFQuantumWarhead03 = Class(AQuantumWarheadProjectile) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
            ...
            nukeProjectile = self:CreateProjectile('/mods/Firey Explosion Mod/hook/projectiles/AIFQuantumWarhead06/AIFQuantumWarhead06_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
