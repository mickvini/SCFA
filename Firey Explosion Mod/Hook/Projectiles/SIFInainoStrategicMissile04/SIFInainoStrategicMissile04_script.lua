#****************************************************************************
#**
#**  File     :  /data/projectiles/SIFInainoStrategicMissile04/SIFInainoStrategicMissile04_script.lua
...
SIFInainoStrategicMissile04 = Class(SIFInainoStrategicMissile) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
            ...
            nukeProjectile = self:CreateProjectile('/mods/Firey Explosion Mod/hook/effects/entities/InainoEffectController04/InainoEffectController04_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
...
TypeClass = SIFInainoStrategicMissile04
