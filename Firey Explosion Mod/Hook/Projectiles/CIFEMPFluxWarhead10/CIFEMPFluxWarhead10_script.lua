...
CIFEMPFluxWarhead10 = Class(NullShell) {
    ...
    CreateNuclearExplosion = function(self)
        ...
        CreateLightParticle(self, -1, self:GetArmy(), 100, 100, 'beam_white_01', 'ramp_red_09')
    ...
    ForceThread = function(self)
        ...
        CreateDecal(self:GetPosition(), RandomFloat(0,2*math.pi), 'nuke_scorch_001_albedo', '', 'Albedo', 14, 14, 250, 0, army)
