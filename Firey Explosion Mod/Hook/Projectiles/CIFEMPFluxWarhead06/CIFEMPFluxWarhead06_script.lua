...
CIFEMPFluxWarhead06 = Class(CEMPFluxWarheadProjectile) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
            ...
            nukeProjectile = self:CreateProjectile('/mods/Firey Explosion Mod/hook/projectiles/CIFEMPFluxWarhead07/CIFEMPFluxWarhead07_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
