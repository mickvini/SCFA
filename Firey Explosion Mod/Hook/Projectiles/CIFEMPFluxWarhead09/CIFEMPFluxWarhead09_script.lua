...
CIFEMPFluxWarhead09 = Class(CEMPFluxWarheadProjectile) {
    FxSplashScale = 0.5,
    FxTrails = {},
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
            ...
            nukeProjectile = self:CreateProjectile('/mods/Firey Explosion Mod/hook/projectiles/CIFEMPFluxWarhead10/CIFEMPFluxWarhead10_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
