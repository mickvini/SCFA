...
CIFEMPFluxWarhead07 = Class(NullShell) {
    ...
    CreateNuclearExplosion = function(self)
        ...
        CreateLightParticle(self, -1, self:GetArmy(), 400, 400, 'beam_white_01', 'ramp_red_09')
        self:ShakeCamera( 150, 6, 0, 40 )
    ...
    ForceThread = function(self)
        ...
        CreateDecal(self:GetPosition(), RandomFloat(0,2*math.pi), 'nuke_scorch_001_albedo', '', 'Albedo', 56, 56, 1000, 0, army)
