...
AIFQuantumWarhead06 = Class(NullShell) {
    ...
    CreateNuclearExplosion = function(self)
        ...
        CreateLightParticle(self, -1, army, 400, 400, 'beam_white_01', 'ramp_quantum_warhead_flash_01')
    ...
    ShakeAndBurnMe = function(self, army)
        self:ShakeCamera( 150, 3, 0, 20 )
        WaitSeconds( 0.5 )
        #CreateDecal(position, heading, textureName, type, sizeX, sizeZ, lodParam, duration, army)");
        local orientation = RandomFloat(0,2*math.pi)
        CreateDecal(self:GetPosition(), orientation, 'Crater01_albedo', '', 'Albedo', 100, 100, 2400, 0, army)
        CreateDecal(self:GetPosition(), orientation, 'Crater01_normals', '', 'Normals', 100, 100, 2400, 0, army)
        self:ShakeCamera( 210, 20, 0, 4 )
        WaitSeconds( 2 )
        self:ShakeCamera( 150, 2, 0, 30 )
    end,
    ...
    InnerCloudFlares = function(self, army)
        ...
        for i = 0, (numFlares - 1) do
            ...
            if math.mod(i,11) == 0 then
                CreateLightParticle(self, -1, army, 26, 6, 'beam_white_01', 'ramp_quantum_warhead_flash_01')
            end
