...
TIFMissileNuke04 = Class(TIFMissileNuke) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
			...
			nukeProjectile = self:CreateProjectile('/mods/Firey Explosion Mod/hook/effects/Entities/UEFNukeEffectController04/UEFNukeEffectController04_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
