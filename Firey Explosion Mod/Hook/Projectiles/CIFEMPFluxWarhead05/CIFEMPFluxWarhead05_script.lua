#****************************************************************************
#**
#**  File     :  /projectiles/CIFEMPFluxWarhead05/CIFEMPFluxWarhead05_script.lua
...
CIFEMPFluxWarhead05 = Class(NullShell) {
    ...
    CreateNuclearExplosion = function(self)
        ...
        CreateLightParticle(self, -1, self:GetArmy(), 800, 800, 'beam_white_01', 'ramp_red_09')
        self:ShakeCamera( 300, 12, 0, 80 )
    ...
    ForceThread = function(self)
        ...
        CreateDecal(self:GetPosition(), RandomFloat(0,2*math.pi), 'nuke_scorch_001_albedo', '', 'Albedo', 112, 112, 2000, 0, army)
