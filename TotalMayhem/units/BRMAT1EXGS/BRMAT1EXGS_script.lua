...
CreatTheEffects = function(self)
	...
	for k, v in EffectTemplate['SmokePlumeLightDensityMed01'] do
		CreateAttachedEmitter(self, 'eff01', army, v):ScaleEmitter(0.35)
	end
	for k, v in EffectTemplate['SmokePlumeLightDensityMed01'] do
		CreateAttachedEmitter(self, 'eff02', army, v):ScaleEmitter(0.35)
	end
	for k, v in EffectTemplate['CMicrowaveLaserMuzzle01'] do
		CreateAttachedEmitter(self, 'eff01', army, v):ScaleEmitter(0.4)
	end
	for k, v in EffectTemplate['CMicrowaveLaserMuzzle01'] do
		CreateAttachedEmitter(self, 'eff02', army, v):ScaleEmitter(0.4)
	end
	for k, v in EffectTemplate['CMicrowaveLaserMuzzle01'] do
		CreateAttachedEmitter(self, 'eff03', army, v):ScaleEmitter(0.4)
	end
	for k, v in EffectTemplate['CMicrowaveLaserMuzzle01'] do
		CreateAttachedEmitter(self, 'eff04', army, v):ScaleEmitter(0.4)
	end
...
CreatTheEffectsDeath = function(self)
	...
	for k, v in TMEffectTemplate['CybranT2BeetleHit01'] do
		CreateAttachedEmitter(self, 'BRMAT1EXGS', army, v):ScaleEmitter(2.35)
	end
end,
}
