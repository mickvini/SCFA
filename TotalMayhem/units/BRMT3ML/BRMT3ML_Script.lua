	        ...
	        PlayFxMuzzleSequence = function(self, muzzle)
		        local army = self.unit:GetArmy()
  	            ...
  	            for k, v in self.FxMuzzleEffect do
                    CreateAttachedEmitter(self.unit, 'Turret_Muzzle', army, v):ScaleEmitter(2.3)
                end
  	            for k, v in self.FxVentEffect2 do
                    CreateAttachedEmitter(self.unit, 'Turret_Muzzle', army, v):ScaleEmitter(1.35)
                end
	            for k, v in self.FxVentEffect3 do
                    CreateAttachedEmitter(self.unit, 'BRMT3ML', army, v):ScaleEmitter(1)
                end
	            ...
	            for k, v in self.FxVentEffect4 do
                    CreateAttachedEmitter(self.unit, 'Turret_Muzzle', army, v):ScaleEmitter(1.6)
                end
            end, 
	},
