	    ...
	    FxGroundEffect = EffectTemplate.ConcussionRingLrg01,
	        ...
	        PlayFxMuzzleSequence = function(self, muzzle)
	            ...
	            for k, v in self.FxGroundEffect do
                    CreateAttachedEmitter(self.unit, 'BROT3BT', army, v):ScaleEmitter(2.55)
                end
	            for k, v in self.FxVentEffect3 do
                    CreateAttachedEmitter(self.unit, 'BROT3BT', army, v):ScaleEmitter(2.1)
                end
...
CreatTheEffectsDeath = function(self)
	...
	for k, v in TMEffectTemplate['AeonUnitDeathRing01'] do
		CreateAttachedEmitter(self, 'BROT3BT', army, v):ScaleEmitter(1.20)
	end
end,
}
