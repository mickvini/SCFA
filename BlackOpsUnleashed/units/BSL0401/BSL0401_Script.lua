    ...
    Weapons = {
        EyeWeapon01 = Class(YenzothaExperimentalLaser) {
			OnWeaponFired = function(self)
        		...
        		for k, v in self.unit.ChargeEffects01 do
            		table.insert( self.unit.ChargeEffects01Bag, CreateAttachedEmitter( self.unit, 'Focus_Beam01_Emitter01', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
        		end
				--WaitSeconds(1)
				...
				for k, v in self.unit.ChargeEffects01 do
					table.insert( self.unit.ChargeEffects01Bag, CreateAttachedEmitter( self.unit, 'Focus_Beam01_Emitter02', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
        		end
				--WaitSeconds(1)
				...
				for k, v in self.unit.ChargeEffects01 do
					table.insert( self.unit.ChargeEffects01Bag, CreateAttachedEmitter( self.unit, 'Focus_Beam01_Emitter03', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
					table.insert( self.unit.ChargeEffects01Bag, CreateAttachedEmitter( self.unit, 'Beam_Point_Focus01', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
        		end
			end,
		...
		EyeWeapon02 = Class(YenzothaExperimentalLaser) {
			OnWeaponFired = function(self)
        		...
        		for k, v in self.unit.ChargeEffects01 do
            		table.insert( self.unit.ChargeEffects02Bag, CreateAttachedEmitter( self.unit, 'Focus_Beam02_Emitter01', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
        		end
				--WaitSeconds(2)
				...
				for k, v in self.unit.ChargeEffects01 do
					table.insert( self.unit.ChargeEffects02Bag, CreateAttachedEmitter( self.unit, 'Focus_Beam02_Emitter02', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
        		end
				--WaitSeconds(2)
				...
				for k, v in self.unit.ChargeEffects01 do
					table.insert( self.unit.ChargeEffects02Bag, CreateAttachedEmitter( self.unit, 'Focus_Beam02_Emitter03', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
					table.insert( self.unit.ChargeEffects02Bag, CreateAttachedEmitter( self.unit, 'Beam_Point_Focus02', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
        		end
			end,
		...
		EyeWeapon03 = Class(YenzothaExperimentalLaser) {
			OnWeaponFired = function(self)
        		...
        		for k, v in self.unit.ChargeEffects01 do
            		table.insert( self.unit.ChargeEffects03Bag, CreateAttachedEmitter( self.unit, 'Focus_Beam03_Emitter01', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
        		end
				--WaitSeconds(3)
				...
				for k, v in self.unit.ChargeEffects01 do
					table.insert( self.unit.ChargeEffects03Bag, CreateAttachedEmitter( self.unit, 'Focus_Beam03_Emitter02', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
        		end
				--WaitSeconds(3)
				...
				for k, v in self.unit.ChargeEffects01 do
					table.insert( self.unit.ChargeEffects03Bag, CreateAttachedEmitter( self.unit, 'Focus_Beam03_Emitter03', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
					table.insert( self.unit.ChargeEffects03Bag, CreateAttachedEmitter( self.unit, 'Beam_Point_Focus03', self.unit:GetArmy(), v ):ScaleEmitter(0.25))
        		end
			end,
