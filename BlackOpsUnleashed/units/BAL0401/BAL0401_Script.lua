...
BAL0401 = Class(AWalkingLandUnit) {
    ...
    OnStopBeingBuilt = function(self,builder,layer)
		...
		--table.insert( self.MaelstromEffects01, CreateAttachedEmitter( self, 'Spinner_Ball', self:GetArmy(), '/mods/BlackopsUnleashed/effects/emitters/genmaelstrom_aura_01_emit.bp' ):ScaleEmitter(0.2):OffsetEmitter(0, -2, 0) )
		--table.insert( self.MaelstromEffects01, CreateAttachedEmitter( self, 'Spinner_Ball', self:GetArmy(), '/mods/BlackopsUnleashed/effects/emitters/genmaelstrom_aura_02_emit.bp' ):ScaleEmitter(0.2):OffsetEmitter(0, -2, 0) )
