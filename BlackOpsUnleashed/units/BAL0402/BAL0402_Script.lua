...
BAL0402 = Class(AHoverLandUnit) {
	...
	OnStopBeingBuilt = function(self,builder,layer)
		...
		if self.MaelstromEffects01 then
			...
			table.insert( self.MaelstromEffects01, CreateAttachedEmitter( self, 'Maelstrom', self:GetArmy(), '/mods/BlackopsUnleashed/effects/emitters/genmaelstrom_aura_01_emit.bp' ):ScaleEmitter(1):OffsetEmitter(0, -2, 0) )
			table.insert( self.MaelstromEffects01, CreateAttachedEmitter( self, 'Maelstrom', self:GetArmy(), '/mods/BlackopsUnleashed/effects/emitters/genmaelstrom_aura_02_emit.bp' ):ScaleEmitter(1):OffsetEmitter(0, -2.75, 0) )
